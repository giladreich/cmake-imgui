...
function(Init_Impl_Files HEADERS_CXX_IMPL_FILES SOURCES_CXX_IMPL_FILES)
  if (IMGUI_IMPL_DX9)
    ...
    set(HEADERS_CXX_IMPL_FILES
      ${BACKENDS_DIR}/imgui_impl_dx9.h
      ${BACKENDS_DIR}/imgui_impl_win32.h
      PARENT_SCOPE
    )
    set(SOURCES_CXX_IMPL_FILES
      ${BACKENDS_DIR}/imgui_impl_dx9.cpp
  ...
  elseif(IMGUI_IMPL_DX10)
    ...
    set(HEADERS_CXX_IMPL_FILES
      ${BACKENDS_DIR}/imgui_impl_dx10.h
      ${BACKENDS_DIR}/imgui_impl_win32.h
      PARENT_SCOPE
    )
    set(SOURCES_CXX_IMPL_FILES
      ${BACKENDS_DIR}/imgui_impl_dx10.cpp
      ${BACKENDS_DIR}/imgui_impl_win32.cpp
      PARENT_SCOPE
    )
  ...
  elseif(IMGUI_IMPL_DX12)
    ...
    set(HEADERS_CXX_IMPL_FILES
      ${BACKENDS_DIR}/imgui_impl_dx12.h
      ${BACKENDS_DIR}/imgui_impl_win32.h
      PARENT_SCOPE
    )
    set(SOURCES_CXX_IMPL_FILES
      ${BACKENDS_DIR}/imgui_impl_dx12.cpp
      ${BACKENDS_DIR}/imgui_impl_win32.cpp
      PARENT_SCOPE
    )
  else()
